...
// Default constructor
position::position() : position_value{0,0} {}

// Parameterised integer pair constructor
position::position(const std::pair<int, int> initial_position) : position_value{initial_position} {}

// Parameterised string pair constructor
// Makes code neater if string conversion occurs in position class constructor
position::position(const std::pair<std::string,std::string> &initial_position) : position_value{[&](){
