...
piece::piece(const colour init_colour, const position& init_position)
		:piece_colour{ init_colour }, piece_position{ init_position } { }
...
bool piece::is_possible_move_legal(const position& init_position, const position& final_position,
		board temp_chess_board) const
{
